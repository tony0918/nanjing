        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="<?php echo $baseUrl;?>race.html" class="text-center">有关赛事</a></li>
              <li><a href="<?php echo $baseUrl;?>race/rule.html" class="text-center">竞赛规程</a></li>
              <li><a href="<?php echo $baseUrl;?>race/map.html" class="text-center">赛事线路图</a></li>
              <li><a href="<?php echo $baseUrl;?>race/faq.html" class="text-center">常见问题</a></li>
            </ul>
          </li>
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="<?php echo $baseUrl;?>signup/guidelines.html" class="text-center">报名须知</a></li>
              <li><a href="<?php echo $baseUrl;?>signup.html" class="text-center">立即报名</a></li>
              <li><a href="<?php echo $baseUrl;?>signup/query.html" class="text-center">报名查询</a></li>
            </ul>
          </li>
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="<?php echo $baseUrl;?>result.html" class="text-center">成绩查询</a></li>
              <li><a href="<?php echo $baseUrl;?>photos.html" class="text-center">照片下载</a></li>
            </ul>
          </li>
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="<?php echo $baseUrl;?>sponsor/sponsorship.html" class="text-center">赛事合作</a></li>
              <li><a href="<?php echo $baseUrl;?>sponsor.html" class="text-center">赞助商</a></li>
            </ul>
          </li>
          <li class="last">
            <div>
              <div class="btn-group btn-group-xs" role="group" aria-label="">
                ...
                <a href="<?php echo $baseUrl;?>en" class="btn btn-primary">EN</a>
              </div>
            </div>
          </li>
        </ul>
