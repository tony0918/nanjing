  ...
  <div class="row">
    <div class="col-sm-12 col-md-8 col-md-offset-2">
      ...
      <div class="text-block">
        ...
        <p>（一）11月18日—12月30日（报名参赛人数额满为止）；</p>
      ...
      <div class="text-block">
        <h4 class="text-title">八、奖励办法</h4>
        <p>（一）所有组别：男、女前6名选手（按枪声计时），分别获得奖品；</p>
        <p>（二）所有组别：规定时间内完赛者均发给“完赛奖牌”。</p>
      </div>
      <div class="text-block">
        <h4 class="text-title">九、参赛保险与医疗救护</h4>
      ...
      <div class="text-block">
        <h4 class="text-title">十三、未尽事项，另行通知。</h4>
      </div>
      <div class="text-block">
