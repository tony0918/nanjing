  ...
  <div class="row">
    <div class="col-sm-12 col-md-8 col-md-offset-2">
      ...
      <div class="text-block">
        ...
        <p>All events: December 15th, 10:00,2016 - February 15th, 17:00,2017.</p>
      ...
      <div class="text-block">
        ...
        <p>After the registration is confirmed, you won’t be allowed to change your race event. There won’t be any
          refund either if you quit the race.</p>
      </div>
      <div class="text-block">
        <h4 class="text-title">9. Physical check</h4>
        <p>Mountain marathon is a high-intensity and long-distance competitive sports event, and with high risk as well.
          Running a marathon requires a good physical condition. Participants shall be running and training regularly on
          a long-term basis. The race committee doesn’t require participants to hand in their physical check reports,
          but we do suggest you have physical checks before the registration.</p>
      </div>
      <div class="text-block">
      ...
      <div class="text-block">
        ...
        <p>Participants are disallowed to carry flags larger than 30 x 20cm with them in any part of the race area,
          including the start location, the finish location and the course.</p>
      </div>
      ...
      <div class="text-block">
        ...
        <p>The race committee suggests participants log onto the official website and print the race certificates by
          self-service.</p>
      </div>
      <div class="text-block">
        <h4 class="text-title">9. How to arrive at and leave the start and finish location?</h4>
        <p>The start and finish location is located in the Panlong Lake in Jiangning District (the reservoir of the
          Village Zhao). The race committee will offer shuttle buses traveling between the Baijia Lake in Jiangning
          District and the Panlong Lake, the start and finish location.</p>
      ...
      <div class="text-block">
        ...
        <p>The race committee won’t offer parking lots for private cars. In consideration of the temporary traffic
          control, we suggest participants, their families and friends take the race shuttle buses to get to and leave
          the start/finish location.</p>
      </div>
      <div class="text-block">
      ...
      <div class="text-block">
        ...
        <p>Each participant in all groups who is able to finish the race within the regulated time will get a finisher’s
          medal. The top 6 male runners and the top 6 female runners (by gunshot time) in each group will be
          awarded.</p>
      </div>
      <div class="text-block">
      ...
      <div class="text-block">
        ...
        <p>The race committee won’t assist the participants with the reservation of hotels. But we will publicize a list
          of hotels located in Juangning District, Nanjing, along with their ways of contacts in the official
          website.</p>
      </div>
      <div class="text-block">
        <h4 class="text-title">2. How can families and friends get to the race site to support the runners?</h4>
        <p>The race committee can't arrange for families and friends to watch the race along the course, but they can
          watch the race at the start/finish location.</p>
        <p>Families and friends can buy “Family Card” online. Each card will cost 120 RMB (regardless of age), with
          shuttle bus fees and meals at the finish location covered.</p>
        <p>The time and location to take the bus for families and friends is the same as runners. “Family Card” will be
          handed out along with the race packet.</p>
      </div>
      <div class="text-block">
        <h4 class="text-title">3. How to sponsor the race?</h4>
        <p>Please call 021-6567 3828 or look through the official website of the race for the detailed information.</p>
      </div>
