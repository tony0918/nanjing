  ...
  <div class="row">
    <div class="col-sm-12 col-md-8 col-md-offset-2">
      ...
      <div class="text-center">
        <p>
          <a onclick="_hmt.push(['_trackEvent', 'btn:query', 'click', 'query','cn']);" class="btn btn-default btn-lg" href="http://iranshao.com/register/reg_races/2018NANJINGMOUNTAIN/query?guest_register=false" target="_blank">报名查询</a>
        </p>
      </div>
