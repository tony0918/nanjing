      ...
      <div class="container">
        <div class="row">
          <div class="image-block col-md-4 col-xs-12">
            <div>
              <img src="<?php echo $baseUrl; ?>assets/small-kv1.jpg?2" alt="" class="img-rounded img-responsive"/>
            </div>
            <p class="desc">Discover，enjoy the cultural and natural beauty of Nanjing</p>
          </div>
          <div class="image-block col-md-4 col-xs-12">
            <div>
              <img src="<?php echo $baseUrl; ?>assets/small-kv2.jpg?2" alt="" class="img-rounded img-responsive"/>
            </div>
            <p class="desc">Release your motive power in company with the mountains and the lake</p>
          </div>
          <div class="image-block col-md-4 col-xs-12">
            <div>
              <img src="<?php echo $baseUrl; ?>assets/small-kv3.jpg?2" alt="" class="img-rounded img-responsive"/>
            </div>
